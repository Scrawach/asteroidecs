...
namespace CodeBase.Core.Infrastructure.Systems
{
    public class SpawnSystems : IConnectableSystem
    {
        ...
        public EcsSystems ConnectTo(EcsSystems systems) =>
            systems
                .Add(new SpawnPlayer())
                .Add(new IntervalSpawn(_time, 3f,
                    new SpawnAliens(new RandomPointOnGameScreenPerimeter(_gameScreen, _random))))
                .Add(new IntervalSpawn(_time, 0.2f,
                    new SpawnAsteroids(new RandomPointOnGameScreenPerimeter(_gameScreen, _random))))
                .Add(new SpawnBullet())
